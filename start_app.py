...
_FLASK_LOG = os.path.join(_PROJECT_ROOT, "kinesis_flask.log")
...
def main():
    ...
    print("Starting Kinesis Flask app...")
    ...
    try:
        ...
        if _flask_proc.poll() is not None:
            print("Flask exited immediately. Check kinesis_flask.log")
        else:
            print("  Kinesis AI at http://localhost:5000")
